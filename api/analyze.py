...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        allowed_presets = {
            'specs', 'nameplate', 'energy_label', 'pelp', 'pelp_label', 'auto', 'Auto-Detect from Photo',
            'Air Conditioners', 'Refrigerators & Freezers', 'Television Sets', 'Electric Fans',
            'Clothes Washing Machines', 'Lighting Products', 'Kitchen Appliances', 'Water Heaters & Pumps',
            'Computers & Office', 'Computers & Laptops', 'Other'
        }
        candidate_preset = str(raw_category or raw_preset or 'specs')[:50]
        preset = candidate_preset if candidate_preset in allowed_presets else 'specs'
