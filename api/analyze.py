...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        allowed_presets = {
            'specs', 'Air Conditioners', 'Refrigerators & Freezers', 'Television Sets',
            'Electric Fans', 'Clothes Washing Machines', 'Lighting Products',
            'Kitchen Appliances', 'Water Heaters & Pumps', 'Computers & Office',
            'Computers & Laptops', 'Laundry & Cleaning', 'TV & Entertainment',
            'Lighting & Other', 'Auto-Detect from Photo', 'Other'
        }
