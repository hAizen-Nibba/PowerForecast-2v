...
/** Shared channel name — must match EmailVerifiedPage */
...
export const VerifyEmailPage: React.FC = () => {
  ...
  /** Transition to verified state — shows success inline then redirects */
  ...
  useEffect(() => {
    // ── 1. Supabase auth state listener (same-tab events) ──
