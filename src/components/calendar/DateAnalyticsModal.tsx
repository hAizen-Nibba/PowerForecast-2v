...
export const DateAnalyticsModal: React.FC<DateAnalyticsModalProps> = ({
  ...
  const handleToggleLiveStopwatch = async (app: UserAppliance) => {
    ...
    if (isCurrentlyOn && app.last_turned_on_at) {
      ...
      showSuccess(`Live stopwatch started for ${app.name}! Elapsed runtime is now tracking in real time.`, "Stopwatch Active");
      if (onUsageSaved) onUsageSaved();
    }
  };
            ...
            sx: {
              ...
              backgroundImage: (theme) =>
                theme.palette.mode === "dark"
                  ? "radial-gradient(ellipse at top, rgba(0, 229, 201, 0.12) 0%, rgba(23, 25, 29, 0.98) 70%)"
                  : "radial-gradient(ellipse at top, rgba(13, 148, 136, 0.08) 0%, #ffffff 70%)",
              boxShadow: (theme) =>
                theme.palette.mode === "dark"
                ...
                <Paper
                  ...
                  sx={{
                    ...
                    borderColor: isOverBudget
                      ? "rgba(239, 68, 68, 0.4)"
                      : (theme) => (theme.palette.mode === "dark" ? "rgba(0, 229, 201, 0.25)" : "rgba(13, 148, 136, 0.25)"),
                    bgcolor: (theme) => (theme.palette.mode === "dark" ? "rgba(24, 27, 32, 0.78)" : "background.paper"),
                    backdropFilter: "blur(12px)",
                    display: "flex",
                    flexDirection: "column",
                    gap: 2,
                    boxShadow: (theme) =>
                      theme.palette.mode === "dark" ? "0 8px 32px rgba(0, 0, 0, 0.35)" : "0 4px 20px rgba(0, 0, 0, 0.05)",
                  }}
                >
                  ...
                  >
                    ...
                    <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 1 }}>
                      <Typography variant="caption" sx={{ color: "text.secondary", fontSize: "0.7rem", fontWeight: 700 }}>
                        {isSelectedToday ? (
                          <>Logged Today: <strong style={{ color: "#ffffff" }}>{hours.toFixed(1)} hrs</strong> ({kwh.toFixed(2)} kWh)</>
                        ) : isPastDate ? (
                            ...
                            return (
                              <Chip
                                ...
                                sx={{
                                  ...
                                  fontSize: "0.6875rem",
                                  fontWeight: 800,
                                  bgcolor: (theme) => (theme.palette.mode === "dark" ? "rgba(6, 182, 212, 0.15)" : "rgba(6, 182, 212, 0.1)"),
                                  borderColor: (theme) =>
                                    theme.palette.mode === "dark" ? "rgba(6, 182, 212, 0.4)" : "rgba(8, 145, 178, 0.35)",
                                  border: "1px solid",
                                  color: (theme) => (theme.palette.mode === "dark" ? "#67e8f9" : "#0891b2"),
                                }}
                              />
                            );
                          }
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 1 }}>
                      ...
                      <Box sx={{ display: "flex", alignItems: "center", gap: 1, flexWrap: "wrap" }}>
                        {isSelectedToday && (
                          ...
                          >
                            {isLive ? "Stop Stopwatch" : "Start Stopwatch Now"}
                          </Button>
                        )}
                ...
                >
                  ...
                  <Paper
                    ...
                    sx={{
                      p: 1.5,
                      borderRadius: 1.25,
                      bgcolor: (theme) => (theme.palette.mode === "dark" ? "rgba(24, 27, 32, 0.65)" : "background.paper"),
                      borderColor: "divider",
                      display: "flex",
                      flexDirection: "column",
                      gap: 1,
        ...
        >
          ...
          <DialogContent sx={{ display: "flex", flexDirection: "column", gap: 2, pt: 1.5 }}>
            ...
            {pastSessionSlices.length > 0 && (
              <Paper variant="outlined" sx={{ p: 1.5, borderRadius: 1.25, bgcolor: "rgba(0, 229, 201, 0.08)", borderColor: "rgba(0, 229, 201, 0.2)" }}>
          ...
          <DialogContent sx={{ display: "flex", flexDirection: "column", gap: 2, pt: 1.5 }}>
            <Typography variant="body2" sx={{ color: "text.secondary", fontSize: "0.85rem" }}>
              ...
              <Typography component="span" sx={{ color: "primary.main", fontWeight: 800 }}>
                {progressiveRoutinePrompt.durationHours} hours
              </Typography>{" "}
              for this device. Would you like to use{" "}
              <Typography component="span" sx={{ color: "primary.main", fontWeight: 800 }}>
                {progressiveRoutinePrompt.durationHours}h/day
              </Typography>{" "}
              as your baseline target routine?
            </Typography>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
              ...
              <Paper
                ...
                sx={{
                  ...
                  transition: "all 0.15s ease",
                  "&:hover": {
                    bgcolor: (theme) => (theme.palette.mode === "dark" ? "rgba(255, 255, 255, 0.08)" : "action.selected"),
                  },
                }}
              >
